      ...
      <f7-accordion-content>
        <f7-block>
              <f7-list media-list v-if="project.times !==undefined && project.times !== null ">
               <f7-list-item v-for="thistime in project.times" :key="thistime.id" :link="`/admin-userDetails/${thistime.user.id}/`" :header="thistime.user.firstname" :subtitle="'Temps saisi :'+thistime.time +' heures'" :after="thistime.date"></f7-list-item>
              </f7-list>
