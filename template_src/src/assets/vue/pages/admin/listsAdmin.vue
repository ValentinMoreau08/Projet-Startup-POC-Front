    ...
    <f7-tabs swipeable>
      <f7-tab id="tab-1" tab-active>
        <f7-block-title class="searchbar-found"
          >Liste de tous les utilisateurs</f7-block-title
        >
      ...
      <f7-tab id="tab-2">
        <f7-block-title class="searchbar-found"
          >Liste des administrateurs</f7-block-title
        >
        <f7-list class="components-list searchbar-found">
          <f7-list-item
            ...
            :link="`/admin-userDetails/${admin.id}/`"
            after="Voir plus de détails"
          >
            <!-- :link="`/insecte/${insecte.id}/`" media="static/img/icon-insecte.png"> -->
          </f7-list-item>
      ...
      <f7-tab id="tab-3">
        <f7-block-title class="searchbar-found"
          >Liste des développeurs</f7-block-title
        >
        <f7-list class="components-list searchbar-found">
          <f7-list-item
            ...
            :link="`/admin-userDetails/${developer.id}/`"
            after="Voir plus de détails"
          >
            <!-- :link="`/insecte/${insecte.id}/`" media="static/img/icon-insecte.png"> -->
          </f7-list-item>
      ...
      <f7-tab id="tab-4">
        <f7-block-title class="searchbar-found"
          >Liste des managers</f7-block-title
        >
        <f7-list class="components-list searchbar-found">
          <f7-list-item
            ...
            :link="`/admin-userDetails/${manager.id}/`"
            after="Voir plus de détails"
          >
            <!-- :link="`/insecte/${insecte.id}/`" media="static/img/icon-insecte.png"> -->
          </f7-list-item>
...
export default {
  created() {
    ...
    //ALL USERS
    Axios.get("http://localhost:8180" + "/users")
      .then(response => {
    ...
    //ALL DEVS
    Axios.get("http://localhost:8180" + "/simple_users")
      .then(response => {
    ...
    //ALL MANAGERS
    Axios.get("http://localhost:8180" + "/managers")
      .then(response => {
    ...
    //ALL ADMINS
    Axios.get("http://localhost:8180" + "/admins")
      .then(response => {
