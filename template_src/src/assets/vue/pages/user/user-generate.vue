<template>
  <f7-page>
    ...
    <f7-list>
      ...
      <f7-list-item>
        <f7-button sheet-open=".demo-sheet"
          >Générer compte rendu mensuel</f7-button
        >
      </f7-list-item>
    </f7-list>
    <f7-sheet
      ...
      <f7-page-content>
        ...
        <f7-list>
          <f7-list-item
            external
            :link="
              'http://localhost:8180/users/month/' +
                user +
                '/' +
                month +
                '/' +
...
export default {
  ...
  data: function() {
    ...
    var linkExportMonthly =
      "http://localhost:8180" + "/users/month/" + currentLoggedIn;
    var linkExport =
      "http://localhost:8180" + "/users/" + currentLoggedIn + "/exportDoc";
    return {
